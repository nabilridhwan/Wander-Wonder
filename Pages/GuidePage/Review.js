...
import { Text, FlatList, Image, StyleSheet, View, TouchableHighlight, TouchableOpacity, TextInput, RefreshControl } from 'react-native';
                        ...
                        <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
                            {
                                rating.map((rating, i) => {
                                    return (
                                        <FilterRatingButton key={i} onPress={() => setFilterRating(rating)} style={(filterRating == rating) ? { elevation: 3, flexDirection: "row", padding: 6, borderRadius: 8, margin: 4, backgroundColor: "#8987FF" } : { flexDirection: "row", padding: 6, borderRadius: 8, margin: 4, borderColor: "#979797", borderWidth: 2 }} ratingText={rating} filterRating={filterRating} />
                                    )
                                })
                            }
                        </View>
                        ...
                        <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
                            {
                                months.map((m, index) => {
                                    return (
                                        ...
                                        <FilterMonthButton key={index} onPress={() => setMonthRating(m)} style={(monthRating == m) ? { elevation: 3, flexDirection: "row", padding: 6, borderRadius: 8, margin: 4, backgroundColor: "#8987FF" } : { flexDirection: "row", padding: 6, borderRadius: 8, margin: 4, borderColor: "#979797", borderWidth: 2 }} month={m} filterMonth={monthRating} />
                                        // <TouchableOpacity>
