   ...
   render() {
     return (
       <View style={styles.container}>
         <ImageBackground source={require('./images/USS.jpg')} style={styles.image}>
           <View style={styles.smallContainer}>
             <Icon name="arrow-back-circle" size={45} color="silver" style={{ marginLeft: 7, marginTop: 7 }} />
             <Icon name="heart" size={45} color="red" style={{ marginRight: 7, marginTop: 7 }} />
           </View>
         ...
         <SwipeUpDown
           ...
           itemFull={
             <View style={styles.panelContainer}>
               <Text style={styles.instructions}>Universal Studio Singapore</Text>
               <Text style={styles.author}>By TheSingaporeTraveller</Text>
